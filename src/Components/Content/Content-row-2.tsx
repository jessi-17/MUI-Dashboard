  ...
  return (
    <Container maxWidth="xl" disableGutters className="flex flex-col  gap-[16px]">
      <Box className="flex justify-between items-center">
        ...
        <Typography className="row-2-subheading">See More <ArrowRight /></Typography>
      </Box>
      <Box className="flex gap-[16px] min-w-min flex-col md:flex-row flex-wrap">
        {cardcontent.map((item) => (
        <Card elevation={0} className="flex-1 flex-wrap flex flex-col !p-[14px] gap-[16px] !rounded-[12px]">
